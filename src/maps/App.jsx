  ...
  return (
    <> 
       <div className="w-screen h-screen">
        ...
        // mapbox://styles/harriputterr/clrpyavi2003o01r60lqq1ikc/draft <--- this is the style for 3d map
        mapStyle={"mapbox://styles/harriputterr/cls3iz7v800dc01pu1tpqcvdu/draft"}
        onMove={(event) => {
