...
function App() {
  ...
  //   fetch(`https://api.mapbox.com/directions/v5/mapbox/walking/-114.056648,51.048041;-114.057117,51.044889?geometries=geojson&access_token=pk.eyJ1IjoiaGFycmlwdXR0ZXJyIiwiYSI6ImNscmw4ZXRvNzBqdzYya3BrcTdhaDlkZGUifQ.croMPXknb0ZuTliWP9BGyw`)
  //   .then((data) => {
  //     data.json()
  //     .then((data) => {
  //       console.log(data);
  ...
  return (
    <> 
       <div className="w-screen h-screen">
        ...
        mapStyle={"mapbox://styles/harriputterr/clrpyavi2003o01r60lqq1ikc/draft"}
        onMove={(event) => {
